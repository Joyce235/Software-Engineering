...
public class LinkedTravListTest {
    ...
    public void setUp() throws Exception {
        ...
        empty = new LinkedTravList<>(5);
        abc_de = new LinkedTravList<>(5);
        abc_de.insert("E");
        abc_de.insert("D");
        abc_de.insert("C");
        abc_de.insert("B");
    ...
    public void swapRights() {
        TravList<String> x_yz = new LinkedTravList<>(3);
        x_yz.insert("Z");
        x_yz.insert("Y");
        x_yz.insert("X");
        x_yz.reset();
    ...
    @Test
    public void splice() {
        TravList<String> ab_c = new LinkedTravList<>(6);
        TravList<String> xy = new LinkedTravList<>(2);
        ab_c.insert("C");
        ab_c.insert("B");
        ab_c.insert("A");
        ab_c.advance();
        ...
        xy.insert("X");
        ab_c.splice(xy);
        assertEquals(4, ab_c.leftLength());
        assertEquals(1, ab_c.rightLength());
        assertEquals("C", ab_c.getNext());
        assertEquals("Y", ab_c.getPrevious());
    ...
    public void linkedScrollAdvanceEmpty() {
        empty.advance();
        fail();
    }
    ...
    @Test(expected = IllegalStateException.class)
    public void linkedScrollRetreatEmpty() {
        empty.retreat();
        fail();
    }

    @Test(expected = IllegalStateException.class)
    public void linkedScrollRemoveEmpty() {
        empty.delete();
        fail();
    }
