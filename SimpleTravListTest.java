...
public class SimpleTravListTest {
    private TravList<String> empty; // empty travlist with capacity 5
    private TravList<String> abc_de; // travlist with capacity 5

    @Before
    public void setUp() throws Exception {
        empty = new SimpleTravList<>(5);
        abc_de = new SimpleTravList<>(5);
    ...
    public void simpleScrollAdvanceEmpty() {
        empty.advance();
        fail();
    }

    @Test(expected = IllegalStateException.class)
    public void simpleScrollRetreatEmpty() {
        empty.retreat();
        fail();
    }

    @Test(expected = IllegalStateException.class)
    public void simpleScrollRemoveEmpty() {
        empty.delete();
        fail();
    }
